...
local function Initialize()
	...
	local function createFPSOptions()
		this.FPSFrame, 
		this.FPSLabel,
		this.FPSMode = utility:AddNewRow(this, "Maximum Frame Rate", "Selector", {
			"60 FPS",
			"120 FPS",
			"144 FPS",
			"240 FPS",
		...
		this.FPSMode.IndexChanged:connect(function(newValue)
			local selectedFPS = fpsValues[newValue]
			if selectedFPS then
				settings().Rendering.MaxFrameRate = selectedFPS
			end
		end)
	end
