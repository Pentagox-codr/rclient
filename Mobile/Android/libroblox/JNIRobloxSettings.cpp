...
extern "C"
{
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetBaseUrl(JNIEnv* jenv, jclass obj, jstring jsBaseUrl)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetCacheDirectory(JNIEnv* jenv, jclass obj, jstring jsCacheDirectory)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetFilesDirectory(JNIEnv* jenv, jclass obj, jstring jsFilesDirectory)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetExceptionReasonFilename(JNIEnv* jenv, jclass obj, jstring jsExceptionReasonFilename)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeInitFastLog(JNIEnv* jenv, jclass obj)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeInitBreakpad(JNIEnv* jenv, jclass obj, jboolean cleanup)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetPlatformUserAgent(JNIEnv* jenv, jclass obj, jstring jsUserAgent)
{
    platformUserAgent = jstringToStdString(jenv, jsUserAgent);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetRobloxVersion(JNIEnv* jenv, jclass obj, jstring jsRobloxVersion)
{
    robloxVersion = jstringToStdString(jenv, jsRobloxVersion);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetHttpProxy(JNIEnv* jenv, jclass obj, jstring jsProxyPort, jlong proxyPort)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetCookiesForDomain(JNIEnv* jenv, jclass obj, jstring jsDomain, jstring jsCookies)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_RobloxSettings_nativeSetDebugDisplay(JNIEnv* jenv, jclass obj, jint debugDisplayMode)
{
...
JNIEXPORT jboolean JNICALL Java_com_projectpizza_client_RobloxSettings_nativeEnableNDKProfiler(JNIEnv* jenv, jclass obj, jint frequency)
{
