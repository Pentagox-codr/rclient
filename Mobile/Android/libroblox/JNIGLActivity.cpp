...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeStartGame( JNIEnv* jenv, jclass obj, jobject surface, jint jPlaceId, jint jUserId, jstring jsAccessCode,
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativePassInput(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativePassPinchGesture(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativePassTapGesture(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeStopGame(
		JNIEnv* jenv, jclass obj) {
	FASTLOG(FLog::Android, "nativeStopGame");
	PlaceLauncher::getPlaceLauncher().leaveGame(true);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativePassText(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeReleaseFocus(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeOnLowMemory(
		JNIEnv* jenv, jclass obj) {
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeHandleBackPressed(
		JNIEnv* jenv, jclass obj)
{
	weak_ptr<RBX::Game> weakGame = PlaceLauncher::getPlaceLauncher().getCurrentGame();
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeInGamePurchaseFinished(JNIEnv* jenv, jclass obj, jboolean success, jlong player, jstring productId)
{
	weak_ptr<RBX::Game> weakGame = PlaceLauncher::getPlaceLauncher().getCurrentGame();
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeShutDownGraphics( JNIEnv* jenv, jobject surface, jclass obj) {
	RBXASSERT( aNativeWindow != NULL );
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeStartUpGraphics( JNIEnv* jenv, jclass obj, jobject surface, jfloat density, jstring model) {
	RBXASSERT( aNativeWindow == NULL );
	aNativeWindow = ANativeWindow_fromSurface(jenv, surface);
	FASTLOG1(FLog::Android, "Created ANativeWindow at %p", aNativeWindow);
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeVideoAdFinished( JNIEnv* jenv, jclass obj, jboolean adShown) {
