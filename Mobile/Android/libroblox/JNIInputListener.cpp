...
extern "C" {
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassInput(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeGamepadConnectEvent(JNIEnv* jenv, jclass obj, jint deviceId)
{
    RobloxInput::getRobloxInput().handleGamepadConnect(deviceId);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeGamepadDisconnectEvent(JNIEnv* jenv, jclass obj, jint deviceId)
{
    RobloxInput::getRobloxInput().handleGamepadDisconnect(deviceId);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeSetGamepadSupportedKey(JNIEnv* jenv, jclass obj, jint deviceId, jint keyCode, jboolean supported)
{
	RobloxInput::getRobloxInput().handleGamepadKeyCodeSupportChanged(deviceId, keyCode, supported);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeGamepadButtonEvent(JNIEnv* jenv, jclass obj, jint deviceId, jint keyCode, jint buttonState)
{
	RobloxInput::getRobloxInput().handleGamepadButtonInput(deviceId, keyCode, buttonState);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeGamepadAxisEvent(JNIEnv* jenv, jclass obj, jint deviceId, jint actionType, jfloat newValueX, jfloat newValueY, jfloat newValueZ)
{
	RobloxInput::getRobloxInput().handleGamepadAxisInput(deviceId, actionType, newValueX, newValueY, newValueZ);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassPinchGesture(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassTapGesture(
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassSwipeGesture(JNIEnv* jenv, jclass obj, jint swipeDirection, jint numOfTouches)
{
	shared_ptr<RBX::Reflection::ValueArray> touchLocations(rbx::make_shared<RBX::Reflection::ValueArray>());
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassLongPressGesture(JNIEnv* jenv, jclass obj, jint state, jint positionX, jint positionY)
{
	shared_ptr<RBX::Reflection::ValueArray> touchLocations(rbx::make_shared<RBX::Reflection::ValueArray>());
	touchLocations->push_back(RBX::Vector2(positionX, positionY));
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassPanGesture(JNIEnv* jenv, jclass obj, jint state, jint positionX, jint positionY,jfloat totalTranslationX, jfloat totalTranslationY, jfloat velocity)
{
	shared_ptr<RBX::Reflection::ValueArray> touchLocations(rbx::make_shared<RBX::Reflection::ValueArray>());
	touchLocations->push_back(RBX::Vector2(positionX, positionY));
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassRotateGesture(JNIEnv* jenv, jclass obj, jint state, jfloat rotation, jfloat velocity, jint position1X, jint position1Y, jint position2X, jint position2Y)
{
	shared_ptr<RBX::Reflection::ValueArray> touchLocations(rbx::make_shared<RBX::Reflection::ValueArray>());
	touchLocations->push_back(RBX::Vector2(position1X, position1Y));
	touchLocations->push_back(RBX::Vector2(position2X, position2Y));
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassGravityChange(JNIEnv* jenv, jclass obj, jfloat x, jfloat y, jfloat z)
{
	RobloxInput::getRobloxInput().sendGravityEvent(x,y,z);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassAccelerometerChange(JNIEnv* jenv, jclass obj, jfloat x, jfloat y, jfloat z)
{
	RobloxInput::getRobloxInput().sendAccelerometerEvent(x,y,z);
}
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativePassGyroscopeChange(JNIEnv* jenv, jclass obj, jfloat eulerX, jfloat eulerY, jfloat eulerZ,
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeSetAccelerometerEnabled(JNIEnv* jenv, jclass obj, jboolean enabled)
{
	RobloxInput::getRobloxInput().setAccelerometerEnabled(enabled);
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_InputListener_nativeSetGyroscopeEnabled(JNIEnv* jenv, jclass obj, jboolean enabled)
{
