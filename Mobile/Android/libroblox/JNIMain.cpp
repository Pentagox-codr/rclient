...
jint onLoad(JavaVM *vm, void *reserved)
{
    ...
    jclass c = scope.env->FindClass("com/projectpizza/client/ActivityGlView");
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityGlView_nativeCallMessagesFromMainThread(JNIEnv* jenv, jclass obj )
{
