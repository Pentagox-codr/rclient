...
JNIEXPORT void JNICALL Java_com_projectpizza_client_test_CurlTestHelper_initHttpJNI( JNIEnv* jenv, jclass obj) {
...
JNIEXPORT jstring JNICALL Java_com_projectpizza_client_test_CurlTestHelper_getCookieStringJNI( JNIEnv* jenv, jclass obj) {
    std::string cookieStr;
    Http::getCookiesForDomain("projectpizza.net", cookieStr);
...
JNIEXPORT jstring JNICALL Java_com_projectpizza_client_test_CurlTestHelper_doCurlRequestJNI( JNIEnv* jenv, jclass obj, jstring jURL) {
