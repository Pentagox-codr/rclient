...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityCurlTest_nativeOnStart(JNIEnv *jenv, jclass obj)
{
...
JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityCurlTest_nativeOnResume(JNIEnv *jenv, jclass obj)
{
    FASTLOG(FLog::Android, "nativeOnResume");
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityCurlTest_nativeOnPause(JNIEnv *jenv, jclass obj)
{
    FASTLOG(FLog::Android, "nativeOnPause");
}

JNIEXPORT void JNICALL Java_com_projectpizza_client_ActivityCurlTest_nativeOnStop(JNIEnv *jenv, jclass obj)
{
    FASTLOG(FLog::Android, "nativeOnStop");
}

JNIEXPORT jstring JNICALL Java_com_projectpizza_client_ActivityCurlTest_nativeGetURL(JNIEnv *jenv, jclass obj, jstring jsURL)
{
    ...
    {
        std::string response;
        bool externalRequest = url.find("projectpizza.net") == std::string::npos && url.find("robloxlabs.com") == std::string::npos;
...
JNIEXPORT jstring JNICALL Java_com_projectpizza_client_ActivityCurlTest_nativePostAnalytics(JNIEnv *jenv, jclass obj, jstring jsCategory, jstring jsAction, jint value, jstring jsLabel)
{
