...
public class RobloxSettings {
    ...
    public static String  baseUrl()					{ return "https://"  + (isTablet() ? mBaseUrl : mBaseMobileUrl); }
    public static String  baseUrlWWW()          { return "https://" + mBaseUrl; }
    ...
    static String  baseUrlInternalDebug()       { return "https://" + mKeyValues.getString("internalDebugUrl", "failed"); }
