...
public class RBHybridModule {
    ...
    protected static final String NOTIFICATION_MANAGER_POST_ACTION = "com.projectpizza.android.notificationmanager.POST";
    protected static final String NOTIFICATION_MANAGER_CALLBACK_ACTION = "com.projectpizza.hybrid.broadcastreceiver.RESPONSE";
