...
static Reflection::PropDescriptor<Replicator, int> prop_port("Port", category_Data, &Replicator::getPort, &Replicator::setPort, Reflection::PropertyDescriptor::UI, Security::LocalUser);
static Reflection::PropDescriptor<Replicator, std::string> prop_ip("MachineAddress", category_Data, &Replicator::getIpAddress, &Replicator::setIpAddress, Reflection::PropertyDescriptor::UI, Security::LocalUser);
REFLECTION_END();
