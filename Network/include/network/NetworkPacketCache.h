...
namespace RBX {
	namespace Network {
		...
		private:
			...
			rbx::event_signals::scoped_connection addingAssemblyConnection;
			rbx::event_signals::scoped_connection removedAssemblyConnection;
			...
			, public Service
		{
			...
			typedef std::list<rbx::event_signals::connection> ConnectionList;
			...
			public:
				...
				rbx::event_signals::scoped_connection propChangedConnection;
				rbx::event_signals::scoped_connection ancestorChangedConnection;
