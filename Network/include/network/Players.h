...
namespace Network {
	...
	private:
		...
		rbx::event_signals::connection blockUserClientSignalConnection;
		rbx::event_signals::connection blockUserFinishedFromServerConnection;
		rbx::event_signals::connection loadLocalPlayerGuisConnection;
	...
	public:
        ...
        void setLocalPlayerDangerous(Instance* value){}
        ...
        void setPreferredPlayersPublic(int value){}
        ...
        void setClassicChat(bool value){}
        void setBubbleChat(bool value){}
