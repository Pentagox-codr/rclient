...
namespace Network {
	...
	private:
		...
		rbx::event_signals::scoped_connection characterDiedConnection;
		rbx::event_signals::scoped_connection backendDiedSignalConnection;
		rbx::event_signals::scoped_connection spawnLocationChangedConnection;
		rbx::event_signals::scoped_connection simulationRadiusChangedConnection;
		rbx::event_signals::scoped_connection setShutdownMessageConnection;
	...
	public:
		...
		rbx::event_signals::scoped_connection charChildAddedConnection; 
        ...
        void setDataComplexity(int value){};
