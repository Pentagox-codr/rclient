...
static Reflection::PropDescriptor<Player, int>		prop_dataComplexity("DataComplexity", category_Data, &Player::getDataComplexity, &Player::setDataComplexity, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<Player, bool> prop_dataReady("DataReady", category_Data, &Player::getDataReady, &Player::setDataReady, Reflection::PropertyDescriptor::UI);
...
Reflection::EnumPropDescriptor<Player, Player::ChatMode> prop_ChatMode("ChatMode", category_Data, &Player::getChatMode, &Player::setChatMode, Reflection::PropertyDescriptor::UI, Security::RobloxScript);
...
static Reflection::PropDescriptor<Player, bool> prop_Guest("Guest", category_Data, &Player::isGuest, &Player::setIsGuest, Reflection::PropertyDescriptor::UI, Security::RobloxScript);
static Reflection::EnumPropDescriptor<Player, Player::MembershipType> prop_membershipType("MembershipType", category_Data, &Player::getMembershipType, &Player::setMembershipType, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<Player, int> prop_accountAge("AccountAge", category_Data, &Player::getAccountAge, &Player::setAccountAge, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<Player, bool> prop_appearanceDidLoad("AppearanceDidLoad", category_Data, &Player::getAppearanceDidLoad, &Player::setAppearanceDidLoad, Reflection::PropertyDescriptor::Attributes::deprecated(Reflection::PropertyDescriptor::UI), Security::RobloxScript);
...
static Reflection::PropDescriptor<Player, int> prop_getFollowUserId("FollowUserId", category_Data, &Player::getFollowUserId, &Player::setFollowUserId);
...
static Reflection::PropDescriptor<Player, bool> prop_teleported("Teleported", category_Data, &Player::getTeleported, &Player::setTeleported, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING, Security::RobloxScript);
