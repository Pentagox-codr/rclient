...
private:
	...
	rbx::event_signals::scoped_connection playerSpawningConnection;
	rbx::event_signals::scoped_connection playerCharacterAddedConnection;
	rbx::event_signals::scoped_connection playerTorsoPropChangedConnection;
