...
REFLECTION_BEGIN();
static Reflection::PropDescriptor<Players, int> propPlayerCount("NumPlayers", category_Data, &Players::getNumPlayers, &Players::setNumPlayers, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Players, int> depPlayerCount("numPlayers", category_Data, &Players::getNumPlayers, &Players::setNumPlayers, Reflection::PropertyDescriptor::Attributes::deprecated(propPlayerCount, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING));
static Reflection::PropDescriptor<Players, int> propPlayerMaxCount("MaxPlayers", category_Data, &Players::getMaxPlayers, &Players::setMaxPlayers, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<Players, int> propPlayerPreferredCount("PreferredPlayers", category_Data, &Players::getPreferredPlayers, &Players::setPreferredPlayersPublic, Reflection::PropertyDescriptor::UI);
...
Reflection::RefPropDescriptor<Players, Instance> Players::propLocalPlayer("LocalPlayer", category_Data, &Players::getLocalPlayerDangerous, &Players::setLocalPlayerDangerous, Reflection::PropertyDescriptor::UI);
Reflection::RefPropDescriptor<Players, Instance> dep_propLocalPlayer("localPlayer", category_Data, &Players::getLocalPlayerDangerous, &Players::setLocalPlayerDangerous, Reflection::PropertyDescriptor::Attributes::deprecated(Players::propLocalPlayer, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING));
...
Reflection::PropDescriptor<Players, bool> propClassicChat("ClassicChat", category_Data, &Players::getClassicChat, &Players::setClassicChat, Reflection::PropertyDescriptor::UI);
Reflection::PropDescriptor<Players, bool> propBubbleChat("BubbleChat", category_Data, &Players::getBubbleChat, &Players::setBubbleChat, Reflection::PropertyDescriptor::UI);
...
{
	StandardOut::singleton()->printf(MESSAGE_INFO, "Players::onRemoteSysStats disconnect, %s, %s", stat.c_str(), message.c_str());
