...
namespace RBX
{
	...
	static Reflection::PropDescriptor<NetworkSettings, float> prop_freeMemoryMBytes("FreeMemoryMBytes", category_Data, &NetworkSettings::getFreeMemoryMBytes, &NetworkSettings::setFreeMemoryMBytes, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING, Security::Plugin);
    static Reflection::PropDescriptor<NetworkSettings, float> prop_freeMemoryPoolMBytes("FreeMemoryPoolMBytes", category_Data, &NetworkSettings::getFreeMemoryPoolMBytes, &NetworkSettings::setFreeMemoryPoolMBytes, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING, Security::Plugin);
