...
struct LogParameter
{
	...
	template <> LogParameter(const uint64_t t) : type(SQLLPDT_INTEGER), size(sizeof(t)), data(&t) {}
	...
	*/
	...
	LogParameter(uint64_t t) : type(SQLLPDT_INTEGER), size(sizeof(t)), data(t) {}
