...
namespace RBX { 
	...
	protected:
        ...
        virtual void decodeHashItem(PmcHashContainer& netHashes, uint64_t* securityTokens) {}
        virtual void processHashValue(const PmcHashContainer& netHashes) {}
        virtual void processHashValuePost(const uint64_t* const tokens, unsigned int nonce) {}
        virtual void updateHashState(PmcHashContainer& netHashes, uint64_t* securityTokens) {}
	...
	private:
        ...
        void processApiStats(uint64_t apiStats);
	...
	protected:
        ...
        /*override*/ void decodeHashItem(PmcHashContainer& netHashes, uint64_t* securityTokens);
        /*override*/ void processHashValue(const PmcHashContainer& netHashes);
        /*override*/ void processHashValuePost(const uint64_t* const tokens, unsigned int nonce);
        /*override*/ void updateHashState(PmcHashContainer& netHashes, uint64_t* securityTokens);
