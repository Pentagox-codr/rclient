...
public:
	int graphicsMode;
	static volatile std::atomic<long> totalCount;
	...
	void renderThumb(RBX::ViewBase* view, std::string fileType, int cx, int cy, bool hideSky, bool crop, std::string* strOutput);
