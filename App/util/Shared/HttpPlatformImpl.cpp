...
public:
        ...
        ,curlsh(gCurlsh)
    {
        ...
        logCurlError("CURLOPT_MAXREDIRS", curl_easy_setopt(curl, CURLOPT_MAXREDIRS, -1));
        ...
        logCurlError("CURLOPT_SSL_VERIFYHOST", curl_easy_setopt(curl, CURLOPT_SSL_VERIFYHOST, 0));
        ...
        if(Http::authCookie.length() > 0)
        {
            std::string cookie = ".ROBLOSECURITY=" + Http::authCookie;
