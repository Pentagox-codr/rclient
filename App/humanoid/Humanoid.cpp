...
static const Reflection::RefPropDescriptor<Humanoid, PartInstance> propSeatPart("SeatPart", "Control", &Humanoid::getSeatPart, &Humanoid::setSeatPart, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, Vector3> propLuaMoveDirection("MoveDirection", "Control", &Humanoid::getLuaMoveDirection, &Humanoid::setLuaMoveDirection, Reflection::PropertyDescriptor::SCRIPTING);
