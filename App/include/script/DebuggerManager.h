...
namespace RBX
{
	...
	namespace Scripting
	{
		...
		private:
			...
			rbx::event_signals::connection errorSignalConnection;
			rbx::event_signals::connection descendantAddedSignalConnection;
		...
		private:
			...
			rbx::event_signals::scoped_connection scriptStartedConnection;
			rbx::event_signals::scoped_connection scriptStoppedConnection;
			rbx::event_signals::scoped_connection scriptParentChangedConnection;
			rbx::event_signals::scoped_connection scriptClonedConnection;
		...
		public:
            ...
            void setScriptInstance(Instance* value){}
            ...
            void setIsDebugging(bool value){}
