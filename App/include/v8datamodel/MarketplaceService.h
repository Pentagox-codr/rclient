...
namespace RBX {
		...
		, public Service
	{
		...
		rbx::event_signals::scoped_connection playerRemovingConnection;
		...
		rbx::event_signals::scoped_connection playerAddedReceiptConnection;
		rbx::event_signals::scoped_connection playerPurchaseReceiptConnection;
		rbx::event_signals::scoped_connection verifyPurchaseConnection;
