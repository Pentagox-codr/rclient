...
namespace RBX
{
    ...
    public:
		...
		rbx::event_signals::connection textboxFocusBeganConnection;
		rbx::event_signals::connection textboxFocusEndedConnection;
        ...
        void setVREnabled2(bool value){}
		const CoordinateFrame& getUserHeadCFrame() const { return userHeadCFrame; }
        void setUserHeadCFrame2(CoordinateFrame value){}
