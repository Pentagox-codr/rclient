...
namespace RBX {
	...
	public:
		...
		class special_equipped_signal : public rbx::event_signals::signal_with_args<1, void(shared_ptr<Instance>)> //rbx::signal<void(shared_ptr<Instance>)>
		{
		private:
			typedef rbx::event_signals::signal_with_args<1, void(shared_ptr<Instance>)> Super;
		...
		public:
			...
			rbx::event_signals::connection connect(Delegate& function) {
				rbx::event_signals::connection result = Super::connect(function);
	...
	private:
		...
		// "Backend" connections
		rbx::event_signals::scoped_connection_logged handleTouched;			// watches for handle touched
		rbx::event_signals::scoped_connection characterChildAdded;		
		rbx::event_signals::scoped_connection characterChildRemoved;		
		rbx::event_signals::scoped_connection torsoChildAdded;			
		rbx::event_signals::scoped_connection torsoChildRemoved;
		rbx::event_signals::scoped_connection armChildAdded;			
