...
namespace RBX
{
    ...
    public:
        ...
        void setGearGenreSetting(GearGenreSetting value) {}
    ...
    public:
        ...
        void setCreatorIDPublic(int value) {}
        CreatorType getCreatorType() const { return creatorType; }
        void setCreatorType(CreatorType value) {}

        int getPlaceID() const { return placeID; }
        void setPlaceIDPublic(int value) {}
        void setGameIDPublic(int value) {}
        ...
        int getUniverseId() const { return universeId; }
        ...
        void setCanSaveLocal(bool value) {}
        ...
        std::vector<Lua::WeakFunctionRef> bindToCloseCallbacks;
        void addBindToClose(Lua::WeakFunctionRef f);
        void runBindToClose();
    ...
    private:
        rbx::event_signals::scoped_connection unbindResourceSignal;
        ...
        void setLightingDeprecated(Instance *value) {}
