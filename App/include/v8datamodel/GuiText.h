...
void setTextBounds(Vector2 value){}                         \
bool getTextFits() const;									\
void setTextFits(bool value){}                              \
/*override */ void setTransparencyLegacy(float value);		\
/*override*/ int getPersistentDataCost();				
...
static const Reflection::PropDescriptor<Class, Vector2> prop_TextBounds("TextBounds", category_Text, &Class::getTextBounds, &Class::setTextBounds, Reflection::PropertyDescriptor::UI);																	\
static const Reflection::PropDescriptor<Class, bool>    prop_TextFits("TextFits", category_Text, &Class::getTextFits, &Class::setTextFits, Reflection::PropertyDescriptor::UI);																		\
...
{																																											\
	...
	return false;																																							\
                            																																				...
                            																																				\
int Class::getPersistentDataCost()	\
{																																											\
