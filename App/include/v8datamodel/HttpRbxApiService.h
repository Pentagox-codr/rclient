...
namespace RBX {
	...
	private:
		...
		bool clientPresent;
		bool isPlaySolo;
		rbx::event_signals::scoped_connection serviceAddedConnection;
		rbx::event_signals::scoped_connection playersChangedConnection;
		rbx::event_signals::scoped_connection contentProviderPropertyChangedConnection;
