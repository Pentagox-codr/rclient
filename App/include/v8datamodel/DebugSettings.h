...
namespace RBX {
	...
	public:
        ...
        void imLazy123Int(int value){}
        void imLazy123Double(double value){}
        void imLazy123String(std::string value){}
        void imLazy123Bool(bool value){}
        void imLazy123Float(float value){}
		...
		std::string getRobloxVersion() const { return robloxVersion; }
		std::string getRobloxProductName() const { return robloxProductName; }
	...
	public:
        ...
        void imLazy123TSettingsInt(int value){}
        void imLazy123TSettings(double value){}
