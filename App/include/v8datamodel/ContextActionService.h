...
namespace RBX {
    ...
    protected:
        rbx::event_signals::scoped_connection characterChildAddConnection;
        rbx::event_signals::scoped_connection characterChildRemoveConnection;
        rbx::event_signals::scoped_connection localPlayerAddConnection;
