...
namespace RBX {
	...
	protected:
		...
		rbx::event_signals::scoped_connection descentdantAdded;		
		rbx::event_signals::scoped_connection descentdantRemoved;				
		rbx::event_signals::scoped_connection ancestorChanged;
		rbx::event_signals::scoped_connection clumpChangedConnection;
