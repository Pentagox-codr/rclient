...
namespace RBX {
	...
	private:
		...
		rbx::event_signals::scoped_connection touchesConnection;
		rbx::atomic<int> touchSentCounter;
		int touchResetCount;
		int touchSendListId;

		// used to determine number of physics senders
		rbx::event_signals::connection playersChangedConnection;

		ConcurrencyValidator concurrencyValidator;

		/*override*/ void onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider);

		rbx::event_signals::connection assemblyPhysicsOnConnection;
		rbx::event_signals::connection assemblyPhysicsOffConnection;
