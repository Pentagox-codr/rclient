...
namespace RBX {
	...
	private:
		...
		rbx::event_signals::scoped_connection postInertJointConnection;
		rbx::event_signals::scoped_connection postDestroyJointConnection;
		rbx::event_signals::scoped_connection autoJoinConnection;
		rbx::event_signals::scoped_connection autoDestroyConnection;
