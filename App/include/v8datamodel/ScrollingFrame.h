...
namespace RBX
{
	...
	public:
        ...
        void setAbsoluteWindowSize(Vector2 value){}
    ...
    private:
        ...
        rbx::event_signals::scoped_connection inputEndedConnection;
		rbx::event_signals::scoped_connection guiServicePropertyChangedConnection;
		rbx::event_signals::scoped_connection selectionGainedConnection;
		rbx::event_signals::scoped_connection selectionLostConnection;
