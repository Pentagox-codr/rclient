...
public:
    ...
    void setReceiveInterval(float value){}
...
public:
	...
	public:
		PartInstance* part;
		template<typename F>
		rbx::event_signals::connection connect(F slot)
		{
			FASTLOG1(FLog::TouchedSignal, "Signal connected (no upper message = lua) - %p", this);
			rbx::event_signals::connection con = Super::connect(TouchedSlot(slot, part));
    ...
    void setResizeHandleMask(Faces value){}
...
public:
    ...
    void setResizeIncrement(int value){}
	...
	Color3uint8 getColor3uint8() const { return getColor().color3uint8(); }
