...
namespace RBX
{
    ...
    private:
		...
		rbx::event_signals::scoped_connection updateInputConnection;
		rbx::event_signals::scoped_connection inputEndedConnection;
		rbx::event_signals::scoped_connection inputChangedConnection;
		rbx::event_signals::scoped_connection cameraCframeUpdateConnection;
