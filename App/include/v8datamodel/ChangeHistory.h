...
private:
	...
	rbx::event_signals::scoped_connection itemAddedConnection;
	rbx::event_signals::scoped_connection itemRemovedConnection;
	rbx::event_signals::scoped_connection itemChangedConnection;
	rbx::event_signals::scoped_connection runTransitionConnection;
public:
