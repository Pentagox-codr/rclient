...
public:
    ...
    void setTargetSurface(NormalId value){}
	
	virtual RBX::RbxRay getUnitRay() const;
    void setUnitRay(RBX::RbxRay value){}
    ...
    void setViewSizeX(int value){}
	virtual int getViewSizeY() const;
    void setViewSizeY(int value){}
