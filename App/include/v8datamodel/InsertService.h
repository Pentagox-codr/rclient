...
namespace RBX {
    ...
    private:
		...
		rbx::event_signals::connection backendInsertConnection;
		rbx::event_signals::connection backendInsertAssetConnection;
		rbx::event_signals::connection backendInsertAssetVersionConnection;
        rbx::event_signals::scoped_connection backendInternalDeleteConnection;
		...
		rbx::event_signals::connection frontendInsertReadyConnection;
		rbx::event_signals::connection frontendInsertErrorConnection;
