...
class SeatImpl : public ActionStation<Base>
{
	private:
		...
		// "Backend" connections
		rbx::event_signals::scoped_connection seatTouched;
		rbx::event_signals::scoped_connection humanoidDoneSitting;
	...
	public:
        ...
        void setOccupant(Humanoid value){}
        void setOccupantPublic(Humanoid* value){}
};
