...
namespace RBX {
	...
	private:
		...
		// Listener
		rbx::event_signals::scoped_connection heartbeatConnection;
		rbx::event_signals::scoped_connection playerChatMessageConnection;
		rbx::event_signals::scoped_connection gameChatMessageConnection;
