...
public:
	...
	static const Reflection::RefPropDescriptor<Instance, Instance> propParent;
		static const Reflection::RefPropDescriptor<Instance, Instance> propParent2;
    ...
    void setClassNameStr(std::string value){}
...
public:
    ...
    void setPersistentDataCost(int value){}
	...
	const Instance* findConstFirstAncestorOfClass(const std::string& findName) const;
	const Instance* findConstFirstAncestorWhichIsA(const std::string& findName) const;

	Instance* findFirstAncestorByName(const std::string& findName) const
	{
		return const_cast<Instance*>(findConstFirstAncestorByName(findName));
	}

	Instance* findFirstAncestorByNameDangerous(const std::string& findName) const
	{
		return const_cast<Instance*>(findConstFirstAncestorByName(findName));
	}

	Instance* findFirstAncestorOfClass(const std::string& findName) const
	{
		return const_cast<Instance*>(findConstFirstAncestorOfClass(findName));
	}

	Instance* findFirstAncestorOfClassDangerous(const std::string& findName) const
	{
		return const_cast<Instance*>(findConstFirstAncestorOfClass(findName));
	}

	Instance* findFirstAncestorWhichIsA(const std::string& findName) const
	{
		return const_cast<Instance*>(findConstFirstAncestorWhichIsA(findName));
	}

	Instance* findFirstAncestorWhichIsADangerous(const std::string& findName) const
	{
		return const_cast<Instance*>(findConstFirstAncestorWhichIsA(findName));
	}
	...
	const Instance* findConstFirstChildOfClass(const std::string& findName) const;
	const Instance* findConstFirstChildWhichIsA(const std::string& findName) const;
	...
	Instance* findFirstChildOfClass(const std::string& findName)
	{
		return const_cast<Instance*>(findConstFirstChildOfClass(findName));
	}
	Instance* findFirstChildOfClassDangerous(const std::string& findName) const
	{		// used by reflection - breaking from const to non const
		return const_cast<Instance*>(findConstFirstChildOfClass(findName));
	}

	Instance* findFirstChildWhichIsA(const std::string& findName)
	{
		return const_cast<Instance*>(findConstFirstChildWhichIsA(findName));
	}
	Instance* findFirstChildWhichIsADangerous(const std::string& findName) const
	{		// used by reflection - breaking from const to non const
		return const_cast<Instance*>(findConstFirstChildWhichIsA(findName));
	}
	...
	Instance* findFirstChildOfClassRecursive(const std::string& findName);
	Instance* findFirstChildWhichIsARecursive(const std::string& findName);
	...
	shared_ptr<Instance> findFirstChildOfClass2(std::string findName, bool recursive)
	{
		return recursive ? shared_from(findFirstChildOfClassRecursive(findName)) : shared_from(findFirstChildOfClass(findName));
	}

	shared_ptr<Instance> findFirstChildWhichIsA2(std::string findName, bool recursive)
	{
		return recursive ? shared_from(findFirstChildWhichIsARecursive(findName)) : shared_from(findFirstChildWhichIsA(findName));
	}

	shared_ptr<Instance> findFirstAncestorByName2(std::string findName)
	{
		return shared_from(findFirstAncestorByName(findName));
	}

	shared_ptr<Instance> findFirstAncestorOfClass2(std::string findName)
	{
		return shared_from(findFirstAncestorOfClass(findName));
	}

	shared_ptr<Instance> findFirstAncestorWhichIsA2(std::string findName)
	{
		return shared_from(findFirstAncestorWhichIsA(findName));
	}
	...
	static void readDescendants(shared_ptr<Instance> inst, Instances& instances);
