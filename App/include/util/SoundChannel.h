...
namespace RBX {
	...
	namespace Soundscape
	{
		...
		private:
			...
			FMOD_CHANNEL* fmod_channel;		// the latest channel
			...
			rbx::event_signals::scoped_connection serverUpdatedTimeConnection;
			rbx::event_signals::scoped_connection serverScriptUpdatedTimeConnection;
			rbx::event_signals::scoped_connection serverResumedSoundConnection;
			...
			void updateLooped();
			void update3D(FMOD_CHANNEL* channel);
		...
		public:
			...
			bool doFmodChannelAddressesMatch(const FMOD_CHANNEL *channel) const;
            
            FMOD_CHANNEL* getFMODChannel() { return fmod_channel; }
            ...
            void setSoundLength(double value){}
