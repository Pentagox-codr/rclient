...
#ifdef _WIN32
inline bool isDebuggerPresentSafe()
{
    ...
    double elapsed = double(b.QuadPart - a.QuadPart) / freq.QuadPart;
    if (elapsed > 0.05)
        return true;
...
extern const char* const maskAddr;
extern const char* const goldHash;
