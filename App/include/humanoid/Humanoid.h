...
namespace RBX {
	...
	private:
		...
		boost::unordered_map<shared_ptr<PartInstance>, rbx::event_signals::scoped_connection> siblingMap;
		...
		rbx::event_signals::scoped_connection onCFrameChangedConnection;
		rbx::event_signals::scoped_connection humanoidEquipConnection;
	...
	public:
		...
		rbx::event_signals::scoped_connection         onPositionUpdatedByNetworkConnection;
