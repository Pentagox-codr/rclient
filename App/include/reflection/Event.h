...
namespace RBX
{
	...
	namespace Reflection
	{
		...
		*/
		...
		public:
			virtual rbx::event_signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const = 0;
		...
		public:
			inline rbx::event_signals::connection connect(EventSource* source, const boost::function<Signature>& slot) const
            {
				if (source)
				{
					...
					return rbx::event_signals::connection();		// return an empty connection
			}
		...
		protected:
			...
			{}
		public:
			rbx::event_signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const 
			{
				EventArguments foo2;
