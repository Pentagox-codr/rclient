...
static Reflection::PropDescriptor<Plugin, bool> prop_CollisionActive("CollisionEnabled", category_Data, &Plugin::isCollisionOn, &Plugin::setIsCollisionOn, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Plugin, float> prop_GridSize("GridSize", category_Data, &Plugin::getGridSize, &Plugin::setGridSize, Reflection::PropertyDescriptor::UI);
