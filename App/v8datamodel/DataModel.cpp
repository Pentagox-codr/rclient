...
static Reflection::PropDescriptor<DataModel, bool> prop_canSaveLocal("LocalSaveEnabled", category_State, &DataModel::canSaveLocal, &DataModel::setCanSaveLocal, Reflection::PropertyDescriptor::UI, Security::RobloxScript);
...
static Reflection::RefPropDescriptor<DataModel, Workspace> prop_Workspace("Workspace", category_Data, &DataModel::getWorkspace, &DataModel::setWorkspace, Reflection::PropertyDescriptor::UI);
static Reflection::RefPropDescriptor<DataModel, Workspace> prop_workspace("workspace", category_Data, &DataModel::getWorkspace, &DataModel::setWorkspace, Reflection::PropertyDescriptor::Attributes::deprecated(prop_Workspace));
Reflection::RefPropDescriptor<DataModel, Instance> DataModel::prop_lighting("lighting", category_Data, &DataModel::getLightingDeprecated, &DataModel::setLightingDeprecated, Reflection::PropertyDescriptor::Attributes::deprecated());

static Reflection::PropDescriptor<DataModel, int> prop_placeId("PlaceId", category_State, &DataModel::getPlaceID, &DataModel::setPlaceIDPublic, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<DataModel, int> prop_gameId("GameId", category_State, &DataModel::getUniverseId, &DataModel::setGameIDPublic, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<DataModel, int> prop_placeVersion("PlaceVersion", category_State, &DataModel::getPlaceVersion, &DataModel::setPlaceVersion, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<DataModel, int> prop_creatorId("CreatorId", category_State, &DataModel::getCreatorID, &DataModel::setCreatorIDPublic, Reflection::PropertyDescriptor::UI);
...
static Reflection::EnumPropDescriptor<DataModel, DataModel::CreatorType> prop_creatorType("CreatorType", category_State, &DataModel::getCreatorType, &DataModel::setCreatorType, Reflection::PropertyDescriptor::UI);
static Reflection::EnumPropDescriptor<DataModel, DataModel::Genre> prop_genre("Genre", category_State, &DataModel::getGenre, &DataModel::setGenre, Reflection::PropertyDescriptor::UI);
static Reflection::EnumPropDescriptor<DataModel, DataModel::GearGenreSetting> prop_gearGenreSetting("GearGenreSetting", category_State, &DataModel::getGearGenreSetting, &DataModel::setGearGenreSetting, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<DataModel, std::string> prop_getJobId("JobId", "JobInfo", &DataModel::getJobId, &DataModel::setJobId, Reflection::PropertyDescriptor::UI);
...
static Reflection::BoundFuncDesc<DataModel, void(Lua::WeakFunctionRef)> func_bindToClose(&DataModel::addBindToClose, "BindToClose", "function", Security::None);

static Reflection::PropDescriptor<DataModel, std::string> desc_VIPServerId("VIPServerId", category_Data, &DataModel::getVIPServerId, &DataModel::setVIPServerId);
...
static Reflection::PropDescriptor<DataModel, int> desc_VIPServerOwnerId("VIPServerOwnerId", category_Data, &DataModel::getVIPServerOwnerId, &DataModel::setVIPServerOwnerId);
...
void DataModel::addBindToClose(Lua::WeakFunctionRef f)
{
    bindToCloseCallbacks.push_back(f);
}

void DataModel::runBindToClose()
{
    for (auto& weakFunc : bindToCloseCallbacks)
    {
        try
        {
            if (!weakFunc.empty())
            {
				Lua::callCallback(weakFunc, rbx::make_shared<Reflection::Tuple>(), new Lua::WeakThreadRef());
            }
        }
        catch (const std::runtime_error& e)
        {
            RBX::StandardOut::singleton()->printf(MESSAGE_ERROR, "BindToClose callback failed: %s", e.what());
        }
    }
    bindToCloseCallbacks.clear();
}
...
void DataModel::doDataModelSetup(shared_ptr<DataModel> dataModel, bool startHeartbeat, bool shouldShowLoadingScreen)
{
	...
	RBX::DataModel::LegacyLock::mainThreadId = pthread_self();
...
void DataModel::closeDataModel(shared_ptr<DataModel> dataModel)
{
	...
	if (!dataModel->bindToCloseCallbacks.empty()) {
		dataModel->runBindToClose();
	}
...
bool DataModel::currentThreadHasWriteLock() const
{
	...
	return writeRequestingThread == pthread_self();
}
	...
	: dataModel(DataModel::get(context))
{
	if (dataModel)
	{
		...
		dataModel->writeRequestingThread = pthread_self();
	}
}
...
DataModel::scoped_write_request::~scoped_write_request()
{
	if (dataModel)
	{
		...
		RBXASSERT(dataModel->read_requested == 0);
		RBXASSERT(dataModel->writeRequestingThread == pthread_self());
