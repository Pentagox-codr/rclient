...
static Reflection::RefPropDescriptor<SkateboardPlatform, SkateboardController> prop_Controller("Controller", "Control", &SkateboardPlatform::getController, &SkateboardPlatform::setController, Reflection::PropertyDescriptor::UI);
static Reflection::RefPropDescriptor<SkateboardPlatform, Humanoid> prop_ControllingHumanoid("ControllingHumanoid", "Control", &SkateboardPlatform::getControllingHumanoid, &SkateboardPlatform::setControllingHumanoid, Reflection::PropertyDescriptor::UI);
