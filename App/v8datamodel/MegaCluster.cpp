...
static Reflection::PropDescriptor<MegaClusterInstance, std::string> desc_ClusterGridV1("ClusterGrid", category_Data, &MegaClusterInstance::getPackagedClusterGrid, &MegaClusterInstance::setPackagedClusterGridV1, Reflection::PropertyDescriptor::LEGACY, Security::None);
static Reflection::PropDescriptor<MegaClusterInstance, std::string> desc_ClusterGridV2("ClusterGridV2", category_Data, &MegaClusterInstance::getPackagedClusterGrid, &MegaClusterInstance::setPackagedClusterGridV2, Reflection::PropertyDescriptor::LEGACY, Security::None);
...
static Reflection::PropDescriptor<MegaClusterInstance, Region3int16> prop_MaxExtents("MaxExtents", category_Data, &MegaClusterInstance::getMaxExtents, &MegaClusterInstance::setMaxExtents,  PropertyDescriptor::UI );
...
static Reflection::PropDescriptor<MegaClusterInstance, bool>
	prop_IsSmooth("IsSmooth", category_Data, &MegaClusterInstance::isSmooth, &MegaClusterInstance::setIsSmooth, Reflection::PropertyDescriptor::UI, Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(void)> 
