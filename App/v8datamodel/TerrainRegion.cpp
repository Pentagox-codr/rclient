...
REFLECTION_BEGIN();
static Reflection::PropDescriptor<TerrainRegion, Vector3> prop_Extents("SizeInCells", category_Data, &TerrainRegion::getSizeInCells, &TerrainRegion::setSizeInCells, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<TerrainRegion, bool> prop_IsSmooth("IsSmooth", category_Data, &TerrainRegion::isSmooth, &TerrainRegion::setIsSmooth, Reflection::PropertyDescriptor::UI, Security::None);
