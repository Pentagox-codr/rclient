...
REFLECTION_BEGIN();
static const Reflection::PropDescriptor<SkateboardController, float> propThrottle("Throttle", "Axes", &SkateboardController::getThrottle, &SkateboardController::setThrottlePublic, Reflection::PropertyDescriptor::UI);
static const Reflection::PropDescriptor<SkateboardController, float> propSteer("Steer", "Axes", &SkateboardController::getSteer, &SkateboardController::setSteerPublic, Reflection::PropertyDescriptor::UI);
