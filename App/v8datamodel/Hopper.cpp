...
static Reflection::PropDescriptor<HopperBin, std::string> desc_legacyCommand("Command", category_Data, &HopperBin::getLegacyCommand, &HopperBin::setLegacyCommand, Reflection::PropertyDescriptor::LEGACY);
static Reflection::PropDescriptor<HopperBin, std::string> desc_legacyTextureName("TextureName", category_Data, &HopperBin::getLegacyTextureName, &HopperBin::setLegacyTextureName, Reflection::PropertyDescriptor::LEGACY);
REFLECTION_END();
