...
static const PropDescriptor<Attachment, Vector3> prop_WorldPosition("WorldPosition", "Derived Data", &Attachment::getPivotInWorld, &Attachment::imlazyVector3, PropertyDescriptor::UI);
static const PropDescriptor<Attachment, Vector3> prop_WorldRotation("WorldRotation", "Derived Data", &Attachment::getEulerAnglesInWorld, &Attachment::imlazyVector3, PropertyDescriptor::UI);

#ifdef ENABLE_AXES_API
static const PropDescriptor<Attachment, Vector3> prop_Axis("Axis", "Derived Data", &Attachment::getAxisInPart, &Attachment::imlazyVector3, PropertyDescriptor::UI);
...
static const PropDescriptor<Attachment, Vector3> prop_WorldAxis("WorldAxis", "Derived Data", &Attachment::getAxisInWorld, &Attachment::imlazyVector3, PropertyDescriptor::UI);
static const PropDescriptor<Attachment, Vector3> prop_WorldSecondaryAxis("WorldSecondaryAxis", "Derived Data", &Attachment::getSecondaryAxisInWorld, &Attachment::imlazyVector3, PropertyDescriptor::UI);
