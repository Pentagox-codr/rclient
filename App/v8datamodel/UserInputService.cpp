...
namespace RBX {
    ...
    static const Reflection::PropDescriptor<UserInputService, bool>  prop_TouchEnabled("TouchEnabled", category_Data, &UserInputService::getTouchEnabled, &UserInputService::setTouchEnabled);
    static const Reflection::PropDescriptor<UserInputService, bool>  prop_KeyboardEnabled("KeyboardEnabled", category_Data, &UserInputService::getKeyboardEnabled, &UserInputService::setKeyboardEnabled);
    static const Reflection::PropDescriptor<UserInputService, bool>  prop_MouseEnabled("MouseEnabled", category_Data, &UserInputService::getMouseEnabled, &UserInputService::setMouseEnabled);
    static const Reflection::PropDescriptor<UserInputService, bool>  prop_GamepadEnabled("GamepadEnabled", category_Data, &UserInputService::getGamepadEnabled, &UserInputService::setGamepadEnabled);
    ...
    static const Reflection::PropDescriptor<UserInputService, bool>  prop_accelerometerEnabled("AccelerometerEnabled", category_Data, &UserInputService::getAccelerometerEnabled, &UserInputService::setAccelerometerEnabled);
    static const Reflection::PropDescriptor<UserInputService, bool>  prop_gyroscopeEnabled("GyroscopeEnabled", category_Data, &UserInputService::getGyroscopeEnabled, &UserInputService::setGyroscopeEnabled);
	...
	// VR Stuff
    static const Reflection::PropDescriptor<UserInputService, bool> prop_IsVREnabled("IsVREnabled", category_Data, &UserInputService::getVREnabled, &UserInputService::setVREnabled2, Reflection::PropertyDescriptor::Attributes::deprecated());
	static const Reflection::PropDescriptor<UserInputService, CoordinateFrame> prop_UserHeadCFrame("UserHeadCFrame", category_Data, &UserInputService::getUserHeadCFrame, &UserInputService::setUserHeadCFrame2, Reflection::PropertyDescriptor::Attributes::deprecated());

    static const Reflection::PropDescriptor<UserInputService, bool> prop_VREnabled("VREnabled", category_Data, &UserInputService::getVREnabled, &UserInputService::setVREnabled2);
