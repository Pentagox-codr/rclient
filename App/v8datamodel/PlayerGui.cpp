...
static const Reflection::PropDescriptor<CoreGuiService, int> prop_Version("Version", category_Data, &CoreGuiService::getGuiVersion, &CoreGuiService::setGuiVersion);
REFLECTION_END();
