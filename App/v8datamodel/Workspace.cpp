...
static Reflection::RefPropDescriptor<Workspace, Instance> workspace_Terrain("Terrain", category_Behavior, &Workspace::getTerrain, &Workspace::setTerrain, Reflection::PropertyDescriptor::UI, Security::None);
...
void Workspace::render3dAdorn(Adorn* adorn)
	...
	if (Workspace::showHashGrid) {
		...
		if(show3DGrid && (!localPlayer || Network::Players::isCloudEdit(this)))
			RBX::DrawAdorn::zeroPlaneGrid(adorn, *getCamera(), gridSizeModifier, 0, Color3(0.3f,0.3f,0.3f), Color3(0.4f,0.4f,0.4f));
