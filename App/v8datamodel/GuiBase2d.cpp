...
Reflection::PropDescriptor<GuiBase2d, Vector2> GuiBase2d::prop_AbsoluteSize("AbsoluteSize", category_Data, &GuiBase2d::getAbsoluteSize, &GuiBase2d::setAbsoluteSize2, Reflection::PropertyDescriptor::UI);
Reflection::PropDescriptor<GuiBase2d, Vector2> GuiBase2d::prop_AbsolutePosition("AbsolutePosition", category_Data, &GuiBase2d::getAbsolutePosition, &GuiBase2d::setAbsolutePosition2, Reflection::PropertyDescriptor::UI);
