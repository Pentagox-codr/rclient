...
namespace RBX
{
    ...
    REFLECTION_BEGIN();
	static const Reflection::PropDescriptor<GuiService, bool> prop_IsModalDialog("IsModalDialog", category_Data, &GuiService::getModalDialogStatus, &GuiService::setModalDialogStatus, Reflection::PropertyDescriptor::Attributes::deprecated());
	static const Reflection::PropDescriptor<GuiService, bool> prop_IsWindows("IsWindows", category_Data, &GuiService::getIsWindows, &GuiService::setIsWindows, Reflection::PropertyDescriptor::Attributes::deprecated());
	...
	static const Reflection::PropDescriptor<GuiService, bool> prop_menuOpen("MenuIsOpen", category_Data, &GuiService::getMenuOpen, &GuiService::setMenuOpen);
