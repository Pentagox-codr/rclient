...
namespace RBX
{
	...
	const Reflection::PropDescriptor<ScrollingFrame, Vector2> prop_absWindowSize("AbsoluteWindowSize", category_Scrolling, &ScrollingFrame::getAbsoluteWindowSize, &ScrollingFrame::setAbsoluteWindowSize);
