...
static const Reflection::RefPropDescriptor<Seat, Humanoid> propOccupant("Occupant", "Control", &Seat::getOccupant, &Seat::setOccupant, Reflection::PropertyDescriptor::SCRIPTING);
