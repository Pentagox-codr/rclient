...
static const PropDescriptor<PartInstance, float> prop_Density("SpecificGravity", category_Data, &PartInstance::getSpecificGravity, &PartInstance::setSpecificGravity, Reflection::PropertyDescriptor::UI);
REFLECTION_END();
...
const PropDescriptor<PartInstance, RBX::Vector3> prop_Siz("siz", category_Part, &PartInstance::getPartSizeXml, &PartInstance::setPartSizeXml, PropertyDescriptor::LEGACY); // Used to prepare for TA14264
...
const PropDescriptor<PartInstance, Faces> prop_ResizeableFaces("ResizeableFaces", category_Behavior, &PartInstance::getResizeHandleMask, &PartInstance::setResizeHandleMask, PropertyDescriptor::UI);
const PropDescriptor<PartInstance, int>  prop_ResizeIncrement("ResizeIncrement", category_Behavior, &PartInstance::getResizeIncrement, &PartInstance::setResizeIncrement, PropertyDescriptor::UI);
...
const PropDescriptor<PartInstance, float> PartInstance::prop_ReceiveAge("ReceiveAge", category_Part, &PartInstance::getReceiveInterval, &PartInstance::setReceiveInterval, PropertyDescriptor::HIDDEN_SCRIPTING);
