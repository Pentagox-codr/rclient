...
static Reflection::PropDescriptor<DebuggerManager, bool> prop_Enabled("DebuggingEnabled", category_Data, &DebuggerManager::getEnabled, &DebuggerManager::setEnabled);
...
const Reflection::RefPropDescriptor<ScriptDebugger, Instance> prop_Script("Script", category_Data, &ScriptDebugger::getScript, &ScriptDebugger::setScriptInstance, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<ScriptDebugger, bool> prop_IsDebugging("IsDebugging", category_Data, &ScriptDebugger::isDebugging, &ScriptDebugger::setIsDebugging, Reflection::PropertyDescriptor::UI);																	
static Reflection::PropDescriptor<ScriptDebugger, bool> prop_IsPaused("IsPaused", category_Data, &ScriptDebugger::isPaused, &ScriptDebugger::setIsPaused, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<ScriptDebugger, int> prop_CurrentLine("CurrentLine", category_Data, &ScriptDebugger::getCurrentLine, &ScriptDebugger::setCurrentLine, Reflection::PropertyDescriptor::UI);
...
static Reflection::PropDescriptor<DebuggerBreakpoint, int> prop_Line("Line", category_Data, &DebuggerBreakpoint::getLine, &DebuggerBreakpoint::setLinePublic, Reflection::PropertyDescriptor::UI);																	
