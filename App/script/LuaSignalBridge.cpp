...
int EventBridge::connect(lua_State *L) 
{
	...
	rbx::event_signals::connection connection;
...
template<>
const char* Bridge< rbx::event_signals::connection >::className("RBXScriptConnection"); 		

template<>
int Bridge< rbx::event_signals::connection >::on_index(const rbx::event_signals::connection& object, const char* name, lua_State *L)
{
...
template<>
void Bridge< rbx::event_signals::connection >::on_newindex(rbx::event_signals::connection& object, const char* name, lua_State *L)
{
	throw RBX::runtime_error("%s cannot be assigned to", name);
}
