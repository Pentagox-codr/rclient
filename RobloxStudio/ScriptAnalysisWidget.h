...
private:
	...
	boost::shared_ptr<RBX::DataModel> m_dataModel;
    rbx::event_signals::scoped_connection   m_dataModelDescendantAdded;
	rbx::event_signals::scoped_connection   m_dataModelDescendantRemoving;
	rbx::event_signals::scoped_connection   m_treeWidgetEmbeddedSourceRemoved;
