...
AuthoringSettings::AuthoringSettings()
	...
	,defaultScriptFileDir(QDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation)).filePath("ROBLOX/Scripts"))
	...
	,recentSavesDir(QDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation)).filePath("ROBLOX/RecentSaves"))
    ...
    , autoSaveDir(QDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation)).filePath("ROBLOX/AutoSaves"))
    // Advanced
