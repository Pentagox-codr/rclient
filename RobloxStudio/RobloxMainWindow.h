...
private:
    ...
    rbx::event_signals::scoped_connection m_PropertyChangedConnection;
    rbx::event_signals::scoped_connection m_AnalyticTrackedConnection;
	boost::scoped_ptr<RBX::CEvent> m_cloudEditAwaitingShutdown;

    RobloxTextOutputWidget* m_pTextOutput;

	QTimer*		            m_pCounterSenderTimer;
    QElapsedTimer			m_lastAnalyticKeepAliveTime;
	QElapsedTimer			m_lastAnalyticTrackedTime;
