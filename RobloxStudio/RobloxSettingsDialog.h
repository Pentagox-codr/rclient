...
private:
	...
	rbx::event_signals::scoped_connection			m_selectionChangedConnection;
...
private:
	...
	rbx::event_signals::scoped_connection m_descendantAddedConnection;
	rbx::event_signals::scoped_connection m_descendantRemovingConnection;
