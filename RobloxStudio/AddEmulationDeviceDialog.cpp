    ...
    : QDialog(Parent,Qt::WindowTitleHint | Qt::WindowSystemMenuHint)
{
	...
	m_UI.dpiValue->setText(QString("%1 DPI").arg(QApplication::primaryScreen()->logicalDotsPerInch()));
...
{
	StudioDeviceEmulator::EmulationDevice device(m_UI.lineEditName->text(), QApplication::primaryScreen()->logicalDotsPerInch(), m_UI.spinBoxWidth->value(), m_UI.spinBoxHeight->value(), m_UI.checkBoxMobile->checkState());
