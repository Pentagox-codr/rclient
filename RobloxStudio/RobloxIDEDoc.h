...
#endif	
    rbx::event_signals::scoped_connection m_ChangeHistoryConnection;
...
private:
    ...
    public:
        ...
        rbx::event_signals::scoped_connection	ancestryChangedConnection;
    };
	...
	rbx::event_signals::scoped_connection   m_ChangeHistoryConnection;
	rbx::event_signals::scoped_connection	  m_openUrlConnection;
	rbx::event_signals::scoped_connection	  m_contentDataLoadedConnection;
	rbx::event_signals::scoped_connection   m_localPlayerConnection;	
	rbx::event_signals::scoped_connection   m_workspacePropertyChangedConnection;
	rbx::event_signals::scoped_connection   m_dataModelItemChangedConnection;
