...
private:
	...
	rbx::event_signals::scoped_connection						mouseCursorEnabledConnection;
	rbx::event_signals::scoped_connection						mouseCursorChangeConnection;
    rbx::event_signals::scoped_connection                     m_textBoxGainFocus;
    rbx::event_signals::scoped_connection                     m_textBoxReleaseFocus;
	rbx::event_signals::scoped_connection                     m_itemAddedToPlayersConnection;
