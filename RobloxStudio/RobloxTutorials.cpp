...
FASTSTRINGVARIABLE(StudioTutorialsSeeAllUrl, "https://wiki.projectpizza.net");
FASTSTRINGVARIABLE(StudioTutorialsUrl, "https://wiki.projectpizza.net");
FASTSTRINGVARIABLE(StudioTutorialsTOCUrl, "https://wiki.projectpizza.net");
...
, m_firstClick(true)
{
	if (/*!FFlag::StudioShowTutorialsByDefault*/true)
		return;
