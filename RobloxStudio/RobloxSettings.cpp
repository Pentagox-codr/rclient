	...
	if (file.open(QIODevice::ReadOnly))
	{
		...
		if (doc.setContent(&file)) 
		{
			...
			if(docElem.tagName() == "Settings")
			{
				...
				content = docElem.firstChildElement("WebUrl");				
				m_webURL = content.text();
...
#else
	m_tempLocation = QDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation)).filePath("Roblox");
#endif
...
QString RobloxSettings::getWebURL()
{
