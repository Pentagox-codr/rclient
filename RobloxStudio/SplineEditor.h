...
//without it, qt moc interprets 'rbx::event_signals::connection foo' as 'rbx::    signals:   :connection foo' and chokes to death
...
private:
    ...
    SplineDef m_spline;
    rbx::event_signals::scoped_connection m_propChangedConn, m_ancestryChangedConn;
