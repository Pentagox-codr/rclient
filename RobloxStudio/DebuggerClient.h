...
private:
	...
	rbx::event_signals::connection                            m_cRunTransitionConnection;
	rbx::event_signals::connection                            m_cDebuggerAddedConnection;
	rbx::event_signals::connection                            m_cDebuggerRemovedConnection;
...
private:
	...
	std::list<rbx::event_signals::connection>	   		        m_cConnections;
