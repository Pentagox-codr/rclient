...
protected:	
	...
	rbx::event_signals::scoped_connection       m_cPlayerAdded;
	rbx::event_signals::scoped_connection       m_cPlayerRemoving;
...
private:
	...
	boost::shared_ptr<RBX::DataModel>              m_pDataModel;
	boost::shared_ptr<PlayersDataManager>          m_pPlayersDataManager;
	rbx::event_signals::scoped_connection                m_cPlaceIdChange;
