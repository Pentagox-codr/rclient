...
const TextureFormatGL& getTextureFormatGL(Texture::Format format, bool ext3)
{
    if (!ext3)
    {
        if (format == Texture::Format_L8)
        {
            static const TextureFormatGL result = { GL_R8, GL_RED, GL_UNSIGNED_BYTE };
            return result;
        }

        if (format == Texture::Format_LA8)
        {
            static const TextureFormatGL result = { GL_RG8, GL_RG, GL_UNSIGNED_BYTE };
            return result;
        }
    }
