...
namespace Graphics
{
	...
	private:
		...
		// debugging.
		std::vector<rbx::event_signals::connection> connections;
	...
	protected:
		rbx::event_signals::scoped_connection workspaceDescendantAddedConnection;
        rbx::event_signals::scoped_connection propertyChangedSignal;
