...
private:
	...
	rbx::event_signals::scoped_connection renderSteppedConnection;
	rbx::event_signals::scoped_connection getSupportedGamepadKeyCodesConnection;

	rbx::event_signals::scoped_connection setEnabledVibrationMotorsConnection;
	rbx::event_signals::scoped_connection setVibrationMotorConnection;
