...
void OfficeStyle::polish(QWidget* widget)
{
    ...
    {
        QPalette palette = widget->palette();
        palette.setColor(QPalette::All, QPalette::Window, helper().getColor("Ribbon", "RibbonFace"));
        widget->setPalette(palette);
    }
    ...
    {
        QPalette palette = widget->palette();
        palette.setColor(QPalette::Window, helper().getColor(tr("Dialog"), tr("Background")));
        widget->setPalette(palette);
    }
    ...
    else if (qobject_cast<QTabBar*>(widget) && qobject_cast<QMdiArea*>(widget->parentWidget()))
    {
        widget->setAutoFillBackground(true);
        QPalette palette = widget->palette();
        palette.setColor(QPalette::Window, helper().getColor(tr("TabManager"), tr("HeaderFaceLight")));
        widget->setPalette(palette);
