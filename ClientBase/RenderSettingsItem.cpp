...
static Reflection::PropDescriptor<CRenderSettingsItem, float> prop_maxFrameRate("MaxFrameRate", "Performance", &CRenderSettingsItem::getMaxFrameRate, &CRenderSettingsItem::setMaxFrameRate);
...
CRenderSettingsItem::CRenderSettingsItem()
	: isSynchronizedWithPhysics(false), currentDisplaySize(800, 600)
{
	setName("Rendering");
...
void CRenderSettingsItem::setMaxFrameRate(float value)
{
	if (value != maxFrameRate)
	{
		maxFrameRate = value;
		settingsChangedSignal(&prop_maxFrameRate);
	}
}
